...
YAHOO.widget.AutoComplete.prototype._extractQuery = function(sQuery) {
    ...
    // A delimiter has been ; und in the query so extract the latest query from past selections
    if(nDelimIndex > -1) {
    ...
    // No delimiter ; und in the query, so there are no selections from past queries
    else {
        sPrevious = "";
    }
