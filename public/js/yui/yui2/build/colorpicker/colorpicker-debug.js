    ...
    return {
     ...
     f(r) + f(g) + f(b);
        ...
        hex2rgb: function(s) { 
            var f = this.hex2dec;
            n
     [f(s.slice(0, 2)), f(s.slice(2, 4)), f(s.slice(4, 6))];
        },

        /**
         * R
    s the closest websafe color to the supplied rgb value.
         * @method websafe
         * @param r {int|[int, int, int]} the red value, or an
         *        array containing all three parameters
         * @param g {int} the green value
...
(function() {
     ...
     * element that n
presents the colorpicker, or the attribute object to use. 
    ...
    YAHOO.extend(ColorPicker, YAHOO.util.Element, {
     ...
     el;
        ...
        /**
         * R
ads the sliders and converts the values to RGB, updating the
     ...
     false;
        ...
        /**
         * R
    s the element reference that is saved.  The id can be either
     ...
     false;
        ...
        /**
         * R
    s the cached element reference.  If the id is not a string, it
         * is assumed that it is an element and this is n
    ed.
        ...
        initAttributes : function(attr) {
             ...
             * other value fields.  R
ad-only: use setValue to set the
             * controls rgb value.
             * @attribute hex
             * @type [int, int, int]
             * @readonly
            ...
            this.setAttributeConfig(this.OPT.CONTAINER, {
                        ...
                        method: function(container) {
                            if (container) {
                                ...
                                // none.  R
setting the slider constraints
