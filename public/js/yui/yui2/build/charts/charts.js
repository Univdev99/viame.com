...
YAHOO.widget.Chart = function(type, containerId, dataSource, configurationAttributes)
{
	...
	var attributes = {fixedAttributes:{allowScriptAccess:"always"}, flashVars:{allowedDomain : document.location.hrstname}, backgroundColor:"#ffffff", hrst:this, version:9.045};
