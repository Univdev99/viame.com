...
var ContentFlowGlobal = {
    ...
    init: function () {
		...
		this.addStylesheet('inc/css/style.css'); 
        //this.addStylesheet(this.CSSBaseDir+'style.css');
        //this.addStylesheet(this.CSSBaseDir+'style.css');    // FF2: without adding a css-file FF2 hangs on a reload.
