...
class page_models_pages extends Zend_Db_Table_Abstract
{
    protected $_name = 'page_pages';
    ...
    protected $_referenceMap = array(
        ...
        'Parent' => array(
            'columns'           => 'parent_id',
            'refTableClass'     => 'page_models_pages',
            'refColumns'        => array('com_id', 'net_id', 'via_id', 'matrix_counter', 'counter')
        )
    );
}
