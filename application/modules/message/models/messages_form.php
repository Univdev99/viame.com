...
$form_config = array(
    'attribs' => array(
        ...
        'id' => 'message_form',
        'class' => 'form',
        'onsubmit' => 'return (YAHOO.viame.vivin_regula.validate(this, { groups: [regula.Group.message_form] }) && YAHOO.viame.dubsub.check(this));' // Set in the form view script
    ),
    ...
    'elements' => array(
        'title' => array('Text', array(
            ...
            'data-constraints' => '@Required(label="title", message="The {label} field cannot be empty.", groups=[message_form])',
