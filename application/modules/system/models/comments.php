...
class system_models_comments extends Zend_Db_Table_Abstract
{
    protected $_name = 'system_comments';
    
    protected $_sequence = false;
    
    protected $_primary = array('com_id', 'net_id', 'via_id', 'module_id', 'matrix_counter', 'item_counter', 'counter');
