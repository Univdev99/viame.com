...
class Profile_ActiveController extends ViaMe_Controller_Action
{   
    ...
    public function indexAction() {
        ...
        if ($this->_getParam('id')) {
            $this->db->query("UPDATE profile_profiles SET active=(NOT active) WHERE base <> 't' AND member_id=? AND id=?", Array($this->target->id, $this->_getParam('id')));
        }
